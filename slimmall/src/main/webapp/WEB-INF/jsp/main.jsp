		...
		<section class="block-center w3-container">
			...
			<ul id="product-list" class="w3-grayscale">
				<c:forEach var="productVO" items="${productVOs}">
					<li><a href="productOrder.do?idx=${productVO.idx}"> <img
							src="<c:url value='http://localhost/${productVO.imageName}' />">
							<p>
								${productVO.name}<br> <b><fmt:formatNumber
										value="${productVO.price}" pattern="#,###" />원</b>
							</p>
					</a></li>
				</c:forEach>
			</ul>
